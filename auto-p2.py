...
def prepare():
    ...
    #Creamos los bridges correspondientes a las redes virtuales
...
if orden=="prepare":
    prepare()
    print("Se han configurado todas las maquinas virtuales")
...
if orden=="stop":
    stop()
    print("Se han parado (sin liberar) todas las maquinas virtuales")
